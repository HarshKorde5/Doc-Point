...
?>
    ...
    $userfetch = $userrow->fetchAll(PDO :: FETCH_ASSOC);

    // $userrow = $database->query("select * from doctor where docemail='$useremail'");
    // $userfetch=$userrow->fetch_assoc();
    $userid= $userfetch[0]["docid"];
    $username=$userfetch[0]["docname"];
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Settings</p>
                            ...
                            <td width="15%">
                                ...
                                $appointmentrow = $stmt->fetchAll(PDO :: FETCH_ASSOC);
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $spcil_array = $stmt->fetchAll(PDO :: FETCH_ASSOC);
            $spcil_name=$spcil_array[0]["sname"];
            $nic=$row['docnic'];
            $tele=$row['doctel'];
            echo '
            <div id="popup1" class="overlay">
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a class="close" href="../logout.php">&times;</a>
                            <div class="content">
                                You have changed your email ! Please logout and login again with your new email
