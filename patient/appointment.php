            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">My Bookings (<?php echo count($result); ?>)</p>
                    </td>
    ...
    if($_GET){
        ...
        if($action=='booking-added'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                    <br><br>
                        <h2>You have already booked a slot.</h2>
                        <a class="close" href="appointment.php">&times;</a>
                        <div class="content">
                        Your Appointment number is '.$id.'.<br><br>
            ...
            $spcil_res= $stmt->fetchAll(PDO :: FETCH_ASSOC);
            $spcil_name=$spcil_res[0]["sname"];
