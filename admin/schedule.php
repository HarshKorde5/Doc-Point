...
<body>
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $stmt->fetchAll(PDO :: FETCH_ASSOC);
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Sessions (<?php echo count($list110); ?>)</p>
                    </td>
                       ...
                       <center>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sqlmain = $pdo->prepare($query);
                                $sqlmain->execute();
                                $result = $sqlmain->fetchAll(PDO :: FETCH_ASSOC);
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            $result12= $sqlmain12->fetchAll(PDO :: FETCH_ASSOC);
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label"><b>Patients that Already registerd for this session:</b> ('.count($result12)."/".$nop.')</label>
                                    <br><br>
                                </td>
                            </tr>
