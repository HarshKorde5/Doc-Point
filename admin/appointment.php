...
<body>
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Appointments (<?php echo count($list110); ?>)</p>
                    </td>
                ...
                <?php
                    if($_POST){
                        ...
                        // $sqlmain->execute();
                        // $list110 = $sqlmain->fetchAll(PDO :: FETCH_ASSOC);
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            $spcil_res = $pdo->prepare("
                SELECT sname FROM specialties
                WHERE id = :spe ;
            ");
            $spcil_res->execute([
                ':spe' => $spe
            ]);
            $spcil_array = $spcil_res->fetchAll(PDO :: FETCH_ASSOC);
