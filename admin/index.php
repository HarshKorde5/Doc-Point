                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">admin@docpoint.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                    ...
                    <td colspan="2" class="nav-bar" >
                        ...
                        <form action="doctors.php" method="post" class="header-search">
                            ...
                            <?php
                                ...
                                $stmt = $pdo->prepare("
                                    SELECT docname,docemail FROM doctor;
                                ");
                                $stmt->execute();
                                ...
                                foreach ($list1 as $row) {
                                    $d = htmlspecialchars($row['docname']); // Sanitize output
                                    $c = htmlspecialchars($row['docemail']);
                                    echo "<option value='$d'>$d</option>"; // Option with docname
                                    echo "<option value='$c'>$c</option>"; // Option with docemail
                                }
                                // echo '</select>';
                    ...
                    <td width="15%">
                        ...
                        <p class="heading-sub12" style="padding: 0;margin: 0;">
                            <?php 
                                ...
                                ");
                                $stmt->execute();
                                $patientrow = $stmt->fetchAll(PDO::FETCH_ASSOC);
                                ...
                                ");
                                $stmt->execute();
                                $doctorrow = $stmt->fetchAll(PDO::FETCH_ASSOC);
                                ...
                                $appointmentommorow = $stmt->fetchAll(PDO::FETCH_ASSOC);
                                ...
                                $schedulerow = $stmt->fetchAll(PDO::FETCH_ASSOC);
                                ...
                                <tr>
                                    ...
                                    <td style="width: 25%;">
                                        <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                            <div>
                                                    <div class="h1-dashboard" >
                                                        <?php    echo count($appointmentommorow) ; ?>
                                                    </div><br>
                                                    <div class="h3-dashboard" >
                                                        NewBooking &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        $stmt = $pdo->prepare("
                                                            ...
                                                            WHERE 
                                                                schedule.scheduledate >= CURRENT_DATE 
                                                                AND schedule.scheduledate <= CURRENT_DATE + INTERVAL '7 days'
                                                            ORDER BY 
